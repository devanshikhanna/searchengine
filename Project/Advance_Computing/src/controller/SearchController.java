		...
		for(int i=0;i<countarray.length;i++){
			...
			if(countarray[i].contains("frequency")){
				 ...
				 countmatch c1= new countmatch();
					...
					File folder = new File("//Users//bhushanjoshi//Desktop//Advance_Computing//src//htmltotext//");
					File[] listOfFiles = folder.listFiles();
					
					 for (int i1 = 0; i1 < listOfFiles.length; i1++) {
					      if (listOfFiles[i1].isFile()) {
					    	  arrayList.add("//Users//bhushanjoshi//Desktop//Advance_Computing//src//htmltotext//"+listOfFiles[i1].getName());
				...
				File[] listOfFiles = folder.listFiles();
				 ...
				 for (int k = 0; k < listOfFiles.length; k++) {
				      if (listOfFiles[k].isFile()) {
				    	  arrayList.add("//Users//bhushanjoshi//Desktop//Advance_Computing//src//htmltotext//"+listOfFiles[k].getName());
				       // System.out.println( listOfFiles[i].getName());
				      } 
				      }
